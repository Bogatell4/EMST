...
Serial.print("Mesura I= ");
Serial.print(result);
Serial.print('\t');

writeRegister(ADC_CONTROL_REGISTER_2,0x0065);
delay(10);
result = readRegister(ADC_DATA_RESULT);
Serial.print("Mesura Q= ");
Serial.print(result);
Serial.print('\t');
Serial.print('\n');
delay(500);
...
void initAFE4300() {
writeRegister(ADC_CONTROL_REGISTER,0x5120);
delay(10);
writeRegister(MISC1_REGISTER,0x0000);
delay(10);
writeRegister(MISC2_REGISTER,0xFFFF);
delay(10);
writeRegister(DEVICE_CONTROL_1,0x600A);
delay(10);
writeRegister(IQ_MODE_ENABLE,0x8000);
delay(10);
writeRegister(DEVICE_CONTROL_2,0x1000);
delay(10);
writeRegister(BCM_DAC_FREQ,0x003E);
delay(10);
writeRegister(ISW_MATRIX,0x0420);
delay(10);
writeRegister(VSW_MATRIX,0x0420);
delay(10);
