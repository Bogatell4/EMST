function [] = configureAdress()
     ...
     writeData(hex2dec(ISW_MATRIX),hex2dec(0x0420)); %Pin configuration IOUTP0 and IOUTN3, RN RP open.
     writeData(hex2dec(VSW_MATRIX),hex2dec(0x0420)); %Pin configuration VSENSEP0 and VSENSEN3, RN RP open     
